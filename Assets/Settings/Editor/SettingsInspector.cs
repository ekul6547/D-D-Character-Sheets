...
namespace Dweiss
{
    [CustomEditor(typeof(ASettings),true)]
    public class SettingsInspector : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            //script.FileName = EditorGUILayout.TextField("FileName",script.FileName);

            script.LoadSettingInEditorPlay = EditorGUILayout.Toggle("Load File On Play",script.LoadSettingInEditorPlay);

            script.AutoSave = EditorGUILayout.Toggle("Auto Save",script.AutoSave);
        }
